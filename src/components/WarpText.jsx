...
const buildTextCanvas = ({ container, width, height, dpr, props }) => {
  ...
  const numLineHeight = typeof props.lineHeight === 'number' ? props.lineHeight : parseFloat(props.lineHeight)
  let lineHeight = Number.isFinite(numLineHeight) ? fontSizePx * numLineHeight : (parseFloat(computed.lineHeight) || fontSizePx * 0.94)
  probe.remove()
