...
export default function DecryptedText({
  ...
  const containerClass = parentClassName || (Tag !== 'span' ? className : '')
  const charClass = parentClassName ? className : (Tag !== 'span' ? '' : className)
      ...
      <span aria-hidden="true">
        {displayText.split('').map((char, index) => {
          ...
          return (
            <span
              key={index}
              className={isRevealedOrDone ? charClass : encryptedClassName}
            >
              {char}
            </span>
          )
